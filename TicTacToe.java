...
public class TicTacToe extends Application {
    ...
    private BorderPane createContent(){
        ...
        titleLabel.setStyle("-fx-font-size : 40 pt; -fx-font-weight : bold;");
        ...
        scoreBoard.setStyle("-fx-font-size : 16px;-fx-font-weight : bold;");
    ...
    private void showTieDialog(){
        Alert alert=new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Tie");
        alert.setContentText("GameOver !This is a tie");
        alert.showAndWait();
        alert.setHeaderText("");
    }
